...
#define TIMEOUT 30000
    ...
    r = lp->Print_ExtraCommand(TIMEOUT, (char*) "setPageRotate180", (char*) "ON", reply, ec);
    printf("> setPageRotate180: %d\n", r);
    // setPageRotate180 to configure page rotation at 180°, it accepts:
    //     * ON     -> rotation of the page at 180°
    //     * OFF    -> no page rotation
