...
#include "./SDK/decard/include/dcrf32.h"
#include <string>
#include <vector>
#include <memory>
#include <thread>
...
public:
    ...
    /** @ingroup CLithographPrinter Function declaration
        ...
        bool RunApdu(HANDLE dcHandle, string cmd,string &strOutmsg);
        /** @ingroup CLithographPrinter Function declaration
          * @brief  扩展命令
        ...
        bool WriteFile(HANDLE dcHandle, string fileID, string tag, string val, string &strOutmsg);
        bool WriteCA(HANDLE dcHandle, string fileID, string tag, string val,string &strOutmsg);
     ...
     */
         ...
         * @return <0表示失败，==0表示成功。
         */
        CLithographPrinter  *pEvolisPriner = nullptr;
        std::string strPrinterLib;
