...
extern "C" {
   ...
   * @return <0表示失败，==0表示成功。
   */
  short USER_API dc_getusbid(HANDLE icdev, unsigned short *vid, unsigned short *pid);
   ...
   * @param[in] icdev 设备标识符。
   * @param[in] number 编号，0表示内置密码键盘，1表示外置密码键盘。
   * @param[in] mode 模式，0表示获取明文，1表示获取ANSI X9.8 PIN BLOCK加密的按键数据，2表示获取IBM3624加密的按键数据，3表示获取ASCII加密的按键数据。
   ...
   * @return <0表示失败，==0表示成功。
   */
  short USER_API dc_NetParameterConfig(HANDLE icdev, unsigned char channel_number, unsigned char type, unsigned char mode, unsigned char link_timeout_s, unsigned char response_timeout_s, unsigned int long_link_time_s, const char *ip_name, unsigned short ip_port, const char *root_cert_path, const char *client_cert_path, const char *client_key_path);
   ...
   * @return <0表示失败，==0表示成功。
   */
  short USER_API dc_startreadmag2(HANDLE icdev, unsigned char mode);
   ...
   * @return <0表示失败，==0表示成功。
   */
  short USER_API dc_SelfServiceDeviceInit(HANDLE icdev, unsigned char gate_check_mode, unsigned char card_move_mode, unsigned char request_mode, unsigned char *out_data, int *out_len);
   ...
   * @return <0表示失败，==0表示成功。
   */
  short USER_API dc_SelfServiceDeviceWriteMagSpeed(HANDLE icdev, unsigned char value);
   ...
   * @return <0表示失败，==0表示成功。
   */
  short USER_API dc_PulseSignalControl(HANDLE icdev, unsigned char on_off, unsigned char occupation_ratio, unsigned int frequency, unsigned int output_time_ms);
   ...
   * @return <0表示失败，==0表示成功。
   */
  short USER_API dc_TakeTemperatureValues(HANDLE icdev, unsigned short *average_value, unsigned short *maximum_value, unsigned short *minimum_value, unsigned short *ambient_value);
   ...
   * @return <0表示失败，==0表示成功。
   */
  short USER_API dc_ModulePowerControl(HANDLE icdev, unsigned short module_number, unsigned char value);
   ...
   * @return <0表示失败，==0表示成功。
   */
  short USER_API dc_ModuleHeartbeatPacketControl(HANDLE icdev, unsigned short module_number, unsigned char value);
   ...
   * @return <0表示失败，==0表示成功。
   */
  short USER_API dc_NotifyMainAppState(HANDLE icdev, unsigned char value);

  /**
   * @brief  保留。
   */
  short USER_API DC_GetCard_CsnCarId(HANDLE icdev, char *cCardNo, char *cCardType);

  /**
   * @brief  保留。
   */
  short USER_API DC_GetCard_Check(HANDLE icdev, char *cIn, char *cOut);
   ...
   * @return <0表示失败，==0表示成功。
   */
  short USER_API dc_VirtualKeyOutputControl(HANDLE icdev, const unsigned char *param_data, unsigned char param_len, const unsigned char *key_data, unsigned short key_len);
   ...
   * @return <0表示失败，==0表示成功。
   */
  short USER_API dc_AndroidTimingControl(HANDLE icdev, unsigned char power_switch, unsigned char time_s);
   ...
   * @return <0表示失败，==0表示成功。
   */
  short USER_API dc_GetCommBaudrate(HANDLE icdev, unsigned char *value);
   ...
   * @return <0表示失败，==0表示成功。
   */
  short USER_API dc_SetCommBaudrate(HANDLE icdev, unsigned char value);
   ...
   * @return <0表示失败，==0表示成功。
   */
  short USER_API dc_TransmitApdu(HANDLE icdev, unsigned char type, unsigned int slen, unsigned char *sendbuffer, unsigned int *rlen, unsigned char *databuffer);
   ...
   */
  short USER_API dc_TransmitApdu_hex(HANDLE icdev, unsigned char type, unsigned int slen, char *sendbuffer, unsigned int *rlen, char *databuffer);
   ...
   * @return <0表示失败，==0表示成功。
   */
  short USER_API dc_WriteTlvUserConfig(HANDLE icdev, unsigned int tlv_data_len, const unsigned char *tlv_data, int *tag_count, unsigned int *tag_info);
   ...
   * @return <0表示失败，==0表示成功。
   */
  short USER_API dc_ReadTlvUserConfig(HANDLE icdev, int tag_count, const unsigned int *tag_info, unsigned int *tlv_data_len, unsigned char *tlv_data);
   ...
   * @return <0表示失败，==0表示成功。
   */
  short USER_API dc_SAM_CreateFileSystem(HANDLE icdev);
   ...
   * @return <0表示失败，==0表示成功。
   */
  short USER_API dc_SAM_WriteKeySM4(HANDLE icdev, const unsigned char *pucKey);
   ...
   * @return <0表示失败，==0表示成功。
   */
  short USER_API dc_SAM_AlgSM4EncryptECB(HANDLE icdev, const unsigned char *pucIV, const unsigned char *pucInput, int iInputLen, unsigned char *pucOutput, int *piOutputLen);
